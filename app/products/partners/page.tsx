...
const ProductsPartnersPage = () => {
    ...
    if (loading) {
        return (
            <section className="mt-[104px] md:mt-[188px] px-6 lg:px-20 py-12 min-h-[50vh] flex items-center justify-center">
    ...
    return (
        <section className="mt-[104px] md:mt-[188px] px-6 lg:px-20 py-12 min-h-[50vh]">
            <div className="text-center text-4xl mb-8">Products by {partnerName}</div>
