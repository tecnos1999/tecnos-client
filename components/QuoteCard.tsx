...
const QuoteCard: React.FC<QuoteCardProps> = ({ quote, author, job, company }) => {
  return (
    <motion.div
    ...
    >
      <blockquote className="relative p-4 text-sm italic text-gray-600 flex-1 flex items-center justify-center bg-gray-50 rounded-lg shadow-inner group-hover:bg-gray-100 transition duration-300">
        <p className="text-center leading-relaxed">{quote}</p>
        <span className="absolute text-5xl text-gray-300 top-2 left-4 font-bold">&#10077;</span>
        <span className="absolute text-5xl text-gray-300 bottom-2 right-4 font-bold">&#10078;</span>
      </blockquote>
      ...
      <div className="text-center mt-4 flex flex-col space-y-1">
        ...
        <span className="text-sm text-gray-500 uppercase tracking-wide">{job}</span>
